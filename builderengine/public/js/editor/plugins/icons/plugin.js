CKEDITOR.dialog.add( 'simpleLinkDialog', function( editor ) {
        ...
        var html = [
                '<div><link href="http://devcms.radianmx.com/themes/saas/style/font-awesome.css" rel="stylesheet" />' +
        ...
        for ( i = 0; i < size; i++ ) {
                ...
                html.push( '<td class="cke_dark_background cke_centered" style="vertical-align: middle;" role="presentation">' +
                        '<a href="javascript:void(0)" role="option"', ' aria-posinset="' + ( i + 1 ) + '"', ' aria-setsize="' + size + '"', ' aria-labelledby="' + smileyLabelId + '"', ' class="cke_smile cke_hand" tabindex="-1" onkeydown="CKEDITOR.tools.callFunction( ', onKeydown, ', event, this );">', '<i class="icon-home"></i>' +
...
CKEDITOR.plugins.add( 'icons', {
    ...
    init: function( editor ) {
        editor.addCommand( 'iconsDialog', new CKEDITOR.dialogCommand( 'simpleLinkDialog' ) );
        editor.ui.addButton( 'IconsButton', {
