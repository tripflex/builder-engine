        ...
        ignore: 'input[type="hidden"]',
         rules: {
            ...
            group: {
                required: true,
                remote: {
                    url: "/index.php/admin/user/validate_group/" + "<?php echo $group->name?>",
                    type: "post"
                }
            },
                                    ...
                                    <form id="validate" class="form-horizontal" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls controls-row">
                                                <input type="text" name="group" class="required group span12" value="<?php echo $group->name?>">
                                            </div>
                                        </div><!-- End .control-group  -->
                                        <div class="control-group">
                                            <label class="control-label" for="required">Description</label>
                                            <div class="controls controls-row">
                                                <textarea class="span12" rows="5" name="description"><?php echo $group->description?></textarea>
                                            </div>
                                        </div><!-- End .control-group  -->
