                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td style="width: 125px;" class="center"><?=($result->author->name != "") ? $result->author->name : $result->author->username?></td>
                                                <td class="center"><a href="/index.php/admin/module/blog/edit_post/<?=$result->id?>"><span class="i-quill-2"></span></a> <a href="/index.php/admin/module/blog/delete_post/<?=$result->id?>" onclick="return confirm('Are you sure you want to permanently delete this post?')"><span class="i-remove-4"></span></a></td>
                                            </tr>
                                            <? endforeach; ?>
                                        </tbody>
                                        <tfoot>
